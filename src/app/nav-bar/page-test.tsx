...
export default function NavBarTest({pageName}: Props) {
    ...
    return (
        ...
        <>
            ...
            <div className={"w-auto mb-5 bg-gradient-to-r from-blue-600 to-blue-500 drop-shadow-lg rounded-lg"}>
                <div className="grid grid-cols-2 p-3 gap-4 text-white">


                    <div className="grid grid-rows-1 gap-1">
                        <div className="flex justify-start gap-2 ml-1 text-lg">
                            <div className={"text-gray-300"}><a href={'/home-page'}>Support Portal</a> /</div>
            ...
            >
                ...
                <DialogContent>
                    <p className={"text-black text-xl"}> Hie {localStorage.getItem('loggedInUsername')}, are you sure
                ...
                <DialogActions>
                    <button className={"bg-green-700 hover:bg-green-600 text-white w-1/3 h-10 rounded font-bold"}
                            onClick={handleClose}>NO
                    </button>
                    <div className={"w-1/3"}></div>
                    <button className={"bg-red-700 hover:bg-red-600 text-white w-1/3 h-10 rounded font-bold"}
                            onClick={logOut} autoFocus>
                        YES
                    </button>
                </DialogActions>
            </Dialog>
